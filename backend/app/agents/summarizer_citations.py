...
def extract_key_phrases(text: str, top_n: int = 5) -> list[str]:
    ...
    stopwords = {
        ...
        "their", "them", "would", "could", "should", "about", "which",
        "when", "where", "what", "also", "than", "then", "into", "more",
        "some", "such", "these", "those", "both", "each", "other", "over",
        "very", "just", "because", "after", "before", "between", "through",
        "during", "without", "within", "across", "being", "does", "done",
        "make", "made", "take", "told", "said", "came", "came", "like",
    }
