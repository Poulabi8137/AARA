...
class NodeBuilder:
    ...
    def build_evidence_nodes(
        ...
        for i, ev in enumerate(evidence):
            eid = (
                getattr(ev, "id", None) or getattr(ev, "evidence_id", None) or f"ev_{i}"
            )
    ...
    def build_summary_nodes(
        ...
        summary_id = _stable_id(
            "summary", summary.summary[:100] if summary.summary else str(id(summary))
        )
        nodes.append(
            GraphNode(
                node_id=summary_id,
                node_type=NodeType.SUMMARY,
                label=f"Summary: {summary.summary[:80]}"
                if summary.summary
                ...
                metadata=NodeMetadata(
                    ...
                    confidence=summary.statistics.overall_confidence
            ...
            nodes.append(
                GraphNode(
                    ...
                    metadata=NodeMetadata(
                        ...
                        tags=[
                            "gap",
                            g.gap_type if hasattr(g, "gap_type") else "unknown",
                        ],
                        properties={
                            "gap_type": g.gap_type
            ...
            nodes.append(
                GraphNode(
                    ...
                    metadata=NodeMetadata(
                        ...
                        source_id=ctid,
                        confidence=0.5,
                        provenance=[f"contradiction:{ctid}"],
                        tags=["contradiction"],
                        properties={
                            "severity": ct.severity,
                            "sides": len(ct.conflicting_sides),
                        },
                    ),
                )
            )
            ...
            nodes.append(
                GraphNode(
                    ...
                    metadata=NodeMetadata(
                        ...
                        provenance=[f"recommendation:{rid}"],
            ...
            nodes.append(
                GraphNode(
                    ...
                    metadata=NodeMetadata(
                        ...
                        source_id=bpid,
                        confidence=0.7,
                        provenance=[f"best_practice:{bpid}"],
    ...
    def build_experiment_nodes(
        ...
        nodes.append(
            GraphNode(
                ...
                label=f"Experiment: {experiment.query[:80]}"
                if experiment.query
