...
export function CitationSearch({ className }: CitationSearchProps) {
  ...
  useEffect(() => {
    ...
    const savedSearches = localStorage.getItem("citationRecentSearches");
    if (savedSearches) {
    ...
    <div ref={searchRef} className={cn("relative w-full", className)}>
      ...
      <div className="relative">
        ...
        <input
          ...
          placeholder="Search citations, authors, journals..."
